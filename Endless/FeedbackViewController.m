...
- (void)viewDidLoad
{
	...
	self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedStringWithDefaultValue(@"FEEDBACK_SEND_BUTTON", nil, [NSBundle mainBundle], @"Send", "Text of button to send feedback")
																			  style:UIBarButtonItemStyleDone
																			 target:self
																			 action:@selector(sendFeedback:)];
	self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedStringWithDefaultValue(@"CANCEL_ACTION", nil, [NSBundle mainBundle], @"Cancel", "Cancel action")
																			 style:UIBarButtonItemStyleDone
																			target:self
	...
	_commentsPlaceholder = NSLocalizedStringWithDefaultValue(@"FEEDBACK_COMMENTS_PLACEHOLDER", nil, [NSBundle mainBundle], @"What's on your mind? Please leave us your feedback", @"Comments section placeholder text");
}
...
-(NSAttributedString*)generateIntroString {
	NSString *faqPhrase = NSLocalizedStringWithDefaultValue(@"FAQ_LINK_TEXT", nil, [NSBundle mainBundle], @"Frequently Asked Questions", @"FAQ link text");
	NSString *introTextPart1 = [NSLocalizedStringWithDefaultValue(@"FEEDBACK_INTRODUCTION", nil, [NSBundle mainBundle], @"Your feedback makes Psiphon better!", "Introduction text at top of feedback form") stringByAppendingString:@"\n\n"];
	NSString *introTextPart2 = NSLocalizedStringWithDefaultValue(@"FEEDBACK_FAQ_DIRECTION", nil, [NSBundle mainBundle], @"You can find solutions to many common problems in our %@.", "Text referring user to frequently asked questions. %@ is where the separate translation for the phrase 'Frequently Asked Questions' will be placed.");
	...
	if (range.location != NSNotFound) {
		[intro addAttribute:NSLinkAttributeName
					  value:[[NSURL alloc] initWithString:NSLocalizedStringWithDefaultValue(@"FAQ_URL", nil, [NSBundle mainBundle], @"https://psiphon.ca/en/faq.html", @"External link to the FAQ page. Please update this with the correct language specific link (if available) e.g. https://psiphon.ca/fr/faq.html for french.")]
					  range: range];
	}
...
- (NSAttributedString*)generateFooterString {
	NSString *privacyPolicyPhrase = NSLocalizedStringWithDefaultValue(@"PRIVACY_POLICY_LINK_TEXT", nil, [NSBundle mainBundle], @"Privacy Policy", "Privacy Policy link text");
	NSString *feedbackEmail = @"feedback.ios@psiphon.ca";

	NSString *localizedTextPart1 = [NSLocalizedStringWithDefaultValue(@"FEEDBACK_FOOTER_DIAGNOSTIC", nil, [NSBundle mainBundle], @"Please note that this diagnostic data does not identify you, and it helps us keep Psiphon running smoothly.", @"Feedback footer text.") stringByAppendingString:@"\n\n"];
	NSString *footerTextPart2 = [NSLocalizedStringWithDefaultValue(@"FEEDBACK_FOOTER_DATA_COLLECTION", nil, [NSBundle mainBundle], @"Learn more about the data we collect in our %@", @"Feedback footer text referring users to privacy policy. %@ is where the separate translation for the phrase 'Privacy Policy' will be placed.") stringByAppendingString:@"\n\n"];
	NSString *footerTextPart3 = NSLocalizedStringWithDefaultValue(@"FEEDBACK_FOOTER_EMAIL", nil, [NSBundle mainBundle], @"If the above form is not working or you would like to send screenshots, please email us at %@", @"Feedback footer text referring users to feedback email. %@ is where the separate translation for the email will be placed.");
	...
	if (privacyPolicyTextRange.location != NSNotFound) {
		[footer addAttribute:NSLinkAttributeName
					   value:[[NSURL alloc] initWithString:NSLocalizedStringWithDefaultValue(@"PRIVACY_POLICY_URL", nil, [NSBundle mainBundle], @"https://psiphon.ca/en/privacy.html", @"External link to the privacy policy page. Please update this with the correct language specific link (if available) e.g. https://psiphon.ca/fr/privacy.html for french.")]
